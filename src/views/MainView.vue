  ...
  <div class="main-view">
    ...
    <div class="settings-panel">
      ...
      <div class="settings-group">
        ...
        <label>
          Radius:
          <input type="range" min="2" max="25" step="0.5" v-model.number="lidarRadius" />
          {{ lidarRadius }}m
        </label>
        <label>
          Rays:
          <input type="range" min="8" max="180" step="4" v-model.number="lidarNumRays" />
          {{ lidarNumRays }}
        </label>
        <label>
          FOV:
      ...
      <div class="settings-group">
        ...
        <label>
          ...
          <span class="field-controls">
            <button @click="decreaseFieldSize" :disabled="fieldSize <= 20">-</button>
      ...
      <div class="settings-group">
        ...
        <label>
          Speed:
          <input type="range" min="0.02" max="0.2" step="0.01" v-model.number="robotSpeed" />
      ...
      <div class="settings-group">
        <h3>Controls</h3>
        <button @click="resetSimulation" class="reset-btn">Reset Simulation</button>
